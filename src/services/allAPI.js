...
// 4. To update a specific markdown from server - put (to editor)
export const editMarkdownAPI = async (id, reqBody) => {
  console.log(id);
  return await commonAPI("patch", `${serverURL}/markdown/${id}`, reqBody);
};
